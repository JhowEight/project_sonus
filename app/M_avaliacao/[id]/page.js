        ...
        <div className="my-16">
            ...
            <div className="flex justify-center">
                <div className="text-center">
                    <div className="box-border rounded-3xl bg-[#362D58] px-6 py-4 border-4 border-[#FFD700]">
            ...
            <div className="flex justify-center">
                <div className="box-border rounded-3xl bg-[#362D58] px-6 py-4">
                    ...
                    <div className="flex justify-center">
                        <br/>
                        <br/>
                        <button input onChange={(a)=> setRating(a.target.value) } value={rating.rate} onClick={()=> Rating()} className="bg-[#362D58] hover:bg-purple-950 focus:outline-2 active:[#362D58] cursor-pointer rounded-md border-purple-500 mt-5 p-2 text-white">Enviar avaliação</button>
                        {/* bg-[#362D58] hover:bg-purple-950 focus:outline-2 active:[#362D58] */}
                        <br/>
                        <br/>
                    </div>
                </div>
