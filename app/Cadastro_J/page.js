...
function Cadastro() {
    ...
    function salvar(){
        console.log("E-mail cadastrado:"+usuario.email);
    ...
    return ( 
            ...
            <br/>
            <button onClick={()=> salvar()} value={usuario.email+usuario.senha} type="button" class="focus:outline-none mt-5  text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Cadastrar</button>
            <br/>
            <br/>
